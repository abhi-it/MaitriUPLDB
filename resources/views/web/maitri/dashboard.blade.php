        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                <select  class="form-control" id="categories" name="categories" required>
                    ...
                    <option value="sexed_semen_calf_born_elite_calf"> लिंग-निर्धारण वीर्य से पैदा हुआ बछड़ा - एलीट बछड़ा</option>
                    <option value="10_liter_day_desi_cow_elite_ndigenous_cow">10 लीटर/दिन देसी गाय - कुलीन स्वदेशी गाय</option>
                </select>
            </div>
            <div class="form-group">
