...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="{{ asset('assets/banners/banner1.jpg')}}" alt="First slide">
    </div>
				...
				<div class="row">
					<div class="col-md-4" style="margin-left: 30px;">
						<a href="{{url('avedan-karein')}}">
							<img src="{{ asset('images/register-now-button.png')}}" style="height: 70px;"><a>
					</div>
					<div class="col-md-4" style="margin-left: 30px;">
						<a href="{{url('application-status')}}">
							<img src="{{ asset('images/check-status.png')}}" style="height: 70px;"></a>
					</div>
				</div>
	</div>
