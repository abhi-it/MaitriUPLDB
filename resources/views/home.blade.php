...
<section class="py-4">
    <div class="container">
        <div class="row g-3">
            <div class="col-lg-12">
                <h5 class="site--heading"> <a href="{{route('gallery-page')}}"> <span data-hi="फोटो गैलरी"
...
<section class="py-5 my-3 counter-section">
    <div class="container">
        <div class="d-flex mb-5 flex-column align-items-center justify-content-center text-white text-center">
            <h2 class="fw-bold"> <span data-hi="भारत पशुधन दैनिक डैशबोर्ड उत्तर प्रदेश"
                    data-en="Bharat Pashudhan Daily Dashboard Uttar Pradesh"></span> </h2>
        </div>
        <div class="row g-3">
            <div class="col-lg-3 p-2">
                <div class="text-center">
                    <h5 class="fw-bold logo-title"><span
                            data-hi="{{ $dailyDashboard['heading_of_ai'] ?? 'Number of AI Done' }}"
                            data-en="{{ $dailyDashboard['heading_of_ai'] ?? 'Number of AI Done' }}"></span> </h5>
                    <p class="text-center text-white fs-4 cattle counter">{{ $dailyDashboard['num_of_ai'] ?? '1182' }}
                    </p>
                </div>
            </div>
            <div class="col-lg-3 p-2">
                <div class="text-center">
                    <h5 class="fw-bold logo-title"><span
                            data-hi="{{ $dailyDashboard['heading_of_pd'] ?? 'Number of PD Done' }}"
                            data-en="{{ $dailyDashboard['heading_of_pd'] ?? 'Number of PD Done' }}"></span></h5>
            ...
            <div class="col-lg-3 p-2">
                <div class="text-center">
                    <h5 class="fw-bold logo-title"><span
                            data-hi="{{ $dailyDashboard['heading_of_calving'] ?? 'Number of Calving Done' }}"
                            data-en="{{ $dailyDashboard['heading_of_calving'] ?? 'Number of Calving Done' }}"></span>
                    </h5>
            ...
            <div class="col-lg-3 p-2">
                <div class="text-center">
                    <h5 class="fw-bold logo-title"><span
                            data-hi="{{ $dailyDashboard['heading_of_insurance'] ?? 'Number of Insurance Done' }}"
                            data-en="{{ $dailyDashboard['heading_of_insurance'] ?? 'Number of Insurance Done' }}"></span>
                    </h5>
                    <p class="text-center text-white fs-4 counter">
                        {{ $dailyDashboard['number_of_insurance'] ?? '1900' }}</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                ...
                                <div class="position-absolute">
                                    <p> <span data-hi="आराजीलाइन्स वाराणसी बीएमएफ"
                                            data-en="Arazilines Varanasi BMF"></span> </p>
                                    <a href="#"> <span data-hi="और जानें" data-en="Know More"></span> </a>
                                </div>
                            </div>
