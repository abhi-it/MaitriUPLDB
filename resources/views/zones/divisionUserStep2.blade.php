...
@section('content')
    ...
    <div x-data="deoUser()" class="container main-div" style="background-color:white; height: 100%;min-height:380px;">
        <h3 class="text-center m-4 fw-bold"> <span data-hi="डिवीजन आईडी बनाएं" data-en="Create Division ID"></span> </h3>
        ...
        function deoUser() {
            return {
                ...
                submitForm() {
                    ...
                    let url = "{{ route('store-division-user-data') }}"
                    axios.post(url, formData).then(response => {
                        ...
                        if (response.status == 200) {
                            ...
                            Swal.fire({
                                ...
                                window.location.href = "{{ route('zone-inventory') }}"
                            });
                        }
                    }).catch(error => {
