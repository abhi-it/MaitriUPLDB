...
@section('content')
    ...
    <div x-data="deoUser()" class="container main-div" style="background-color:white; height: 100%;min-height:380px;">
        <h3 class="text-center m-4 fw-bold"> <span data-hi="क्षेत्र आईडी बनाएं" data-en="Create Zone ID"></span> </h3>
        ...
        function deoUser() {
            return {
                ...
                createDEOUser() {
                    ...
                    axios.post('{{ route('zone-store-data') }}', {
                            zone: selectedZoneValue,
                        })
                        .then(response => {
                            console.log(response.data);
                            window.location.href = '{{ route('zone-user-create-form') }}';
