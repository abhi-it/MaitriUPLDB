...
@section('content')
    ...
    <div x-data="deoUser()" class="container main-div" style="background-color:white; height: 100%;min-height:380px;">
        <h3 class="text-center m-4 fw-bold"> <span data-hi="ज़िला ऑपरेटर आईडी बनाएं" data-en="Create Zone Operator ID"></span> </h3>
        ...
        function deoUser() {
            return {
                ...
                submitForm() {
                    ...
                    let url = "{{ route('zone-user-store-data') }}"
                    axios.post(url, formData).then(response => {
                        ...
                        if (response.status == 200) {
                            ...
                            Swal.fire({
                                title: 'Success!',
                                text: 'Zone User created successfully!',
                                icon: 'success',
