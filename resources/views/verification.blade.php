...
<table id="myTable" class="table">
    ...
    <tbody>
        ...
        <tr>
			<td><input type="checkbox" value="{{$row->id}}" name="application_id[]" id="application_id" class="checkBoxClass"></td>
...
<!-- Modal -->
<div class="modal fade" id="setDateTimeModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">डॉक्युमेंट वेरिफिकेशन के लिए दिनांक और समय सेट कीजिए</h5>
      ...
      <div class="modal-body">
        <div class="row">
				<div class="form-group col-md-3">
				  ...
				  <input type="text" class="form-control" name="date" id="date" placeholder="दिनांक" readonly>
				</div>
