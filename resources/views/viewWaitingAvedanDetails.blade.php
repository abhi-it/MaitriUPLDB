    ...
    <div class="container main-div" style="background-color:white; height: 100%;">
        ...
        <div class="tab1">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    @if ($result->permanent_address_proof != '')
                        <a href="{{ url('downloadFiles', $result->permanent_address_proof) }}">Download</a>
                    @else
                        No documents
                    @endif
                ...
                <div class="form-group col-md-4">
                    ...
                    @if ($result->applicant_photo != '')
                        <div class="form-control-span" id="applicant_photo1">
                            <img height="100" src="{{ asset('') }}upload_documents/{{ $result->applicant_photo }}">
                        </div>
                        <div class="form-control-span" id="applicant_photo1">
                            <a href="{{ url('downloadFiles', $result->applicant_photo) }}">Download</a>
                        </div>
                    @else
                        No documents
                    @endif
                ...
                <div class="form-group col-md-4">
                    ...
                    @if ($result->signature != '')
                        <div class="form-control-span" id="signature1">
                            <img height="100" src="{{ asset('') }}upload_documents/{{ $result->signature }}">
                        </div>
                        <div class="form-control-span" id="signature1">
                            <a href="{{ url('downloadFiles', $result->signature) }}">Download</a>
                        </div>
                    @else
                        No documents
                    @endif
            ...
            <div class="row">
                ...
                <div class="row table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><span class="form-control-span" id="high_board_name1">{{ $result->high_board_name }}</span>
                            </td>
                            <td><span class="form-control-span"
                                    id="high_passing_year1">{{ $result->high_passing_year }}</span></td>
                            <td><span class="form-control-span" id="high_marks1"></span>{{ $result->high_marks }}</td>
                            <td><span class="form-control-span"
                                    id="high_total_marks1">{{ $result->high_total_marks }}</span></td>
                            <td><span class="form-control-span"
                                    id="high_percentage1">{{ $result->high_percentage }}</span></td>
                                    ...
                                    @if ($result->high_marksheet != '' && @file_exists(public_path() . '/upload_documents/' . $result->high_marksheet))
                                        <div class="form-control-span" id="signature1">
                                            <img class="img-thumbnail" width="100"
                                                src="{{ asset('') }}upload_documents/{{ $result->high_marksheet }}">
                                        </div>
                                        <div class="form-control-span" id="signature1">
                                            <a href="{{ asset('') }}upload_documents/{{ $result->high_marksheet }}"
                        ...
                        <tr>
                            ...
                            <td><span class="form-control-span"
                                    id="inter_board_name1">{{ $result->inter_board_name }}</span></td>
                            <td><span class="form-control-span"
                                    id="inter_passing_year1">{{ $result->inter_passing_year }}</span></td>
                            <td><span class="form-control-span" id="inter_marks1">{{ $result->inter_marks }}</span></td>
                            <td><span class="form-control-span"
                                    id="inter_total_marks1">{{ $result->inter_total_marks }}</span></td>
                            <td><span class="form-control-span"
                                    id="inter_percentage1">{{ $result->inter_percentage }}</span></td>
                            <td><span class="form-control-span" id="inter_certificate1">
                                    @if ($result->inter_marksheet != '' && @file_exists(public_path() . '/upload_documents/' . $result->inter_marksheet))
                                        <div class="form-control-span" id="signature1">
                                            <img class="img-thumbnail" width="100"
                                                src="{{ asset('') }}upload_documents/{{ $result->inter_marksheet }}">
                                        </div>
                                        <div class="form-control-span" id="signature1">
                                            <a href="{{ asset('') }}upload_documents/{{ $result->inter_marksheet }}"
                                                target="_blank">View</a>
                                        </div>
                                    @else
                                        No documents
                        ...
                        <tr>
                            ...
                            <td><span class="form-control-span"
                                    id="inter_board_name1">{{ $result->graduation_board_name }}</span></td>
                            <td><span class="form-control-span"
                                    id="inter_passing_year1">{{ $result->graduation_passing_year }}</span></td>
                            <td><span class="form-control-span" id="inter_marks1">{{ $result->graduation_marks }}</span>
                            </td>
                            <td><span class="form-control-span"
                                    id="inter_total_marks1">{{ $result->graduation_total_marks }}</span></td>
                            <td><span class="form-control-span"
                                    id="inter_percentage1">{{ $result->graduation_percentage }}</span></td>
                            <td><span class="form-control-span" id="inter_certificate1">
                                    @if (
                                        $result->graduation_marksheet != '' &&
                                            @file_exists(public_path() . '/upload_documents/' . $result->graduation_marksheet))
                                        <div class="form-control-span" id="signature1">
                                            <img class="img-thumbnail" width="100"
                                                src="{{ asset('') }}upload_documents/{{ $result->graduation_marksheet }}">
                                        </div>
                                        <div class="form-control-span" id="signature1">
                                            <a href="{{ asset('') }}upload_documents/{{ $result->graduation_marksheet }}"
                                                target="_blank">View</a>
                                        </div>
                                    @else
                                        No documents
                        ...
                        <tr>
                            ...
                            <td><span class="form-control-span"
                                    id="inter_board_name1">{{ $result->postgraduation_board_name }}</span></td>
                            <td><span class="form-control-span"
                                    id="inter_passing_year1">{{ $result->postgraduation_passing_year }}</span></td>
                            <td><span class="form-control-span"
                                    id="inter_marks1">{{ $result->postgraduation_marks }}</span></td>
                            <td><span class="form-control-span"
                                    id="inter_total_marks1">{{ $result->postgraduation_total_marks }}</span></td>
                            <td><span class="form-control-span"
                                    id="inter_percentage1">{{ $result->postgraduation_percentage }}</span></td>
                            <td><span class="form-control-span" id="inter_certificate1">
                                    @if (
                                        $result->postgraduation_marksheet != '' &&
                                            @file_exists(public_path() . '/upload_documents/' . $result->postgraduation_marksheet))
                                        <div class="form-control-span" id="signature1">
                                            <img class="img-thumbnail" width="100"
                                                src="{{ asset('') }}upload_documents/{{ $result->postgraduation_marksheet }}">
                                        </div>
                                        <div class="form-control-span" id="signature1">
                                            <a href="{{ asset('') }}upload_documents/{{ $result->postgraduation_marksheet }}"
                                                target="_blank">View</a>
                                        </div>
                                    @else
                                        No documents
                ...
                <div class="row">
                    @if ($result->training_adopted != 'नहीं')
                        <div class="form-group col-md-9">
                            ...
                            <span class="form-control-span" id="training_certificate1">
                                @if ($result->training_certificate != '')
                                    <img class="img-thumbnail" width="100"
                                        src="{{ asset('') }}upload_documents/{{ $result->training_certificate }}">
                                    <a href="{{ asset('') }}upload_documents/{{ $result->training_certificate }}"
                                        target="_blank">View</a>
                                @else
                                    No documents
                                @endif
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <span class="form-control-span"
                                id="yojna_name_for_training1">{{ $result->yojna_name_for_training }}</span>
                        </div>
                    ...
                    <div class="form-group col-md-12">
                        <label for="inputEmail4">वोटर आई डी कार्ड / आधार कार्ड / पैन कार्ड का प्रमाणपत्र</label> :
                        <span class="form-control-span" id="id_upload1">
                            @if ($result->id_upload != '')
                                <img class="img-thumbnail" width="100"
                                    src="{{ asset('') }}upload_documents/{{ $result->id_upload }}">
                                <a href="{{ asset('') }}upload_documents/{{ $result->id_upload }}"
                                    target="_blank">View</a>
                            @else
                                No documents
                            @endif
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <span class="form-control-span" id="caste_certificate1">
                            @if ($result->caste_certificate != '')
                                <img class="img-thumbnail" width="100"
                                    src="{{ asset('') }}upload_documents/{{ $result->caste_certificate }}">
                                <a href="{{ asset('') }}upload_documents/{{ $result->caste_certificate }}"
                                    target="_blank">View</a>
                            @else
                                No documents
                            @endif
                ...
                @if (auth()->user()->user_type == 'District Officer' and $result->is_approved == 3)
                    ...
                    <form method="post" action="{{ url('rejectApplication') }}" id="myForm"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary communicationAddress1"
                                    data-dismiss="modal">बंद करें</button>
                                <button type="submit" class="btn btn-primary communicationAddress2">अस्वीकार
                                    करें</button>
