...
.form-control-span {
    ...
    transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;
		...
		<div class="row">
		  ...
		  <div class="row">
				...
				<div class="form-group col-md-9">
				  <label for="inputEmail4">राज्य  / केंद्र सरकार द्वारा मान्यता प्राप्त संस्थान से यदि पूर्व में कृत्रिम गर्भाधान के प्रशिक्षण का प्रमाण पत्र प्राप्त किया हो</label> :
				...
				<div class="form-group col-md-12">
				  <label for="inputEmail4">जाति (एस सी / एस टी श्रेणी हेतु न्याय अधिकारी द्वारा जारी प्रमाण पत्र</label> :
		...
		@if(auth()->user()->user_type=='District Officer' AND $result->is_approved==3){ <!-----Then Display these buttons-->

				@if($waitingButtonShow){ <!-----Then Display these buttons-->
