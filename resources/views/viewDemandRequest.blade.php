...
<div class="container main-div" style="background-color:white; height: 100%;">
    ...
    <div class="tab1">
        <div class="row">
            ...
            <div class="form-group col-md-4">
                <label for="inputPassword4">
                    <span data-hi="एआई सेंटर (पशु चिकित्सा अस्पताल / एलईओ सेंटर)"
                        data-en="AI Centre (Veterinary Hospital / LEO Centre)">
                    </span>
            ...
            <div class="form-group col-md-4">
                <label for="inputPassword4">
                    <span data-hi="आपके भारत पशुधन आईडी पर कितने गांव मैप किए गए हैं?"
                        data-en="How many villages are mapped on your Bharat Pashudhan ID?"></span>
                </label> :
            ...
            <div class="form-group col-md-4">
                <label for="inputPassword4">
                    <span data-hi="भारत पशुधन पर पंजीकृत गाय बछड़ों की संख्या"
                        data-en="Number of Cow Calves Registered on Bharat Pashudhan"></span>
                </label> : {{$data->registered_cow_calves}}
            </div>
            <div class="form-group col-md-4">
                <label for="inputPassword4">
                    <span data-hi="भारत पशुधन पर पंजीकृत भैंस बछड़ों की संख्या"
                        data-en="Number of Buffalo Calves Registered on Bharat Pashudhan"></span>
