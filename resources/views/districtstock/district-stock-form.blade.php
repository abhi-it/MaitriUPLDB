        ...
        <form method="post" action="{{ route('district-save-stock-data') }}" class="form-comman">
            ...
            <div class="row">
                    ...
                    <select name="select_aiCenter" id="select_aiCenter" data-type="ai_center" class="form-control" required>
                        ...
                        @if(count($aiCenters)>0)
                            ...
                            @foreach($aiCenters as $aiCenter)
                                <option value="{{ $aiCenter['id'] }}" data-hi="{{ $aiCenter['name'] }}" data-en="{{ $aiCenter['name_eng'] ? $aiCenter['name_eng'] : $aiCenter['name'] }}"></option>  
                            @endforeach
                        @else
                ...
                <div class="form-group col-md-6">
                    ...
                    <input name="banner" min="0" id="banner" data-filed_type="banner" type="number" class="form-control"  data-placeholder-hi="बैनर" data-placeholder-en="Banner" autofocus>
                </div>
                <div class="form-group col-md-6">
                    <label for="inputEmail4"> 
                    ...
                    <input name="dangler" min="0" id="dangler" data-filed_type="dangler" type="number" class="form-control" data-placeholder-hi="डैंगलर चार्ट (संख्या में)" data-placeholder-en="Dangler Chart(In Numbers)" autofocus>
                </div>
                <div class="form-group col-md-6">
                    <label for="inputEmail4"> 
                    ...
                    <input name="standee" min="0" id="standee" data-filed_type="standee" type="number" class="form-control"  data-placeholder-hi="स्टैंडी (संख्या में)" data-placeholder-en="Standee(In Numbers)" autofocus>
                </div>
                <div class="form-group col-md-6">
                    <label for="inputEmail4"> 
                    ...
                    <input name="pamphlet" min="0" id="pamphlet" data-filed_type="pamphlet" type="number" class="form-control"  data-placeholder-hi="पैम्फलेट (संख्या में)" data-placeholder-en="Pamphlet(In Numbers)" autofocus>
                </div>
                <div class="form-group col-md-6">
                    <label for="inputEmail4"> 
                    ...
                    <input name="ai_kit" min="0" id="ai_kit" data-filed_type="ai_kit" type="number" class="form-control" data-placeholder-hi="एआई किट (संख्या में)" data-placeholder-en="AI Kit(In Numbers) " autofocus>
                </div>
                <div class="form-group col-md-6">
                    <label for="inputEmail4"> 
                    ...
                    <input name="container" min="0" id="container" data-filed_type="container" type="number" class="form-control"  data-placeholder-hi="कंटेनर(संख्या में)" data-placeholder-en="Container(In Numbers)" autofocus>
                </div>
                <div class="form-group col-md-6">
                    <label for="inputEmail4"> 
