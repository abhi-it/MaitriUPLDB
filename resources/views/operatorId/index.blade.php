    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="flexbox-style">
                <a href="{{ route('create-zone') }}" class="btn btn-primary mb-2" data-hi="क्षेत्र आईडी बनाएं"
                    data-en="Create Zone ID"></a>
                <a href="{{ route('district-deo-user-step1') }}" data-hi="ज़िला आईडी बनाएं" data-en="Create District ID"
    ...
    <table id="myTable" class="table table-striped  table-responsive table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span data-hi="{{ $zoneUser->getDeoUser->zone->name_hi ?? 'N/A' }}"
                        data-en="{{ $zoneUser->getDeoUser->zone->name_en ?? 'N/A' }}"></span>
                </td>
                <td>
                    <div class="cus-btn">
                        ...
                        <form action="{{ route('user-delete', $zoneUser->id) }}" method="POST"
