...
if(district_id!='' && category!='')
 {
	...
	$.ajax({    //create an ajax request to display.php
        type: "GET",
        url: "{{url('/getAvedanData')}}?district_id=" + district_id + '&category=' + category + '&institute_id=' + institute_id,
        //dataType: "text",  
...
{ 
     ...
     @endif
       ...
       <div class="row" style="padding-top: 20px;background-color: white;">
              ...
              <div class="col-md-8 col-sm-12" style="margin-top: 30px;">
                     <center><h4 class="uttp" key="UTTP" style="color:black;font-weight: bold;"><span style="color:Blue; font-size:28px; padding:1px;"> राष्ट्रीय गोकुल मिशन</span><br /><span style="color:Black; font-size:18px; padding:1px;"> स्वरोजगारी मैत्री (मल्टीपरपज ए0आई0 टेक्निशियन इन रूरल इण्डिया)  हेतु <br /> ऑनलाइन  आवेदन</span></h4> </center>
              </div>
              <div class="col-md-2" style="vertical-align: middle;align-content: center; margin-bottom: 7px;" align="center">
 ...
 <div class="container" style="background-color:white;margin-top: -5px;">
    ...
    <nav class="navbar navbar-inverse  navbar-toggleable-md" style="background-color:#ea7327; font-color:blue;" id="mainbackground">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleContainer" style="font-color:blue;">
          ...
          <li class="nav-item active" >
			...
			@else
				...
				<a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" key="SCHEME">नये आवेदन</a>
					<div class="dropdown-menu" aria-labelledby="dropdown02">
						<a class="dropdown-item" href="{{url('avedan')}}">नये आवेदन</a>
						<a class="dropdown-item" href="{{url('avedan-districtwise')}}">नये आवेदन जनपद वार</a>               
					</div>
				</li>
				@else
				<li class="nav-item active">
				...
				@if(auth()->user()->user_type=='District Officer')
					<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" key="SCHEME">मेरिट सूची (स्क्रीनिंग)</a>
						<div class="dropdown-menu" aria-labelledby="dropdown02">
							<a class="dropdown-item" href="{{url('merit-list')}}/1">सामान्य / अन्य  पिछड़ा वर्ग</a> 
							<a class="dropdown-item" href="{{url('merit-list')}}/2" >अनुसूचित जाति</a>
							<a class="dropdown-item" href="{{url('merit-list')}}/3" >अनुसूचित जनजाति</a>               
						</div>
					</li>
				@endif
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" key="SCHEME">आवेदन</a>
						<div class="dropdown-menu" aria-labelledby="dropdown02">
							<a class="dropdown-item" href="{{url('approved-avedan')}}">स्वीकृत आवेदन</a>
							<a class="dropdown-item" href="{{url('rejected-avedan')}}">अस्वीकृत आवेदन</a>             
						</div>
					</li>
				...
				@if(auth()->user()->user_type=='District Officer')
				<li class="nav-item active">
					  <a class="nav-link" href="{{url('document-verification')}}">अभिलेख सत्यापन</a>
					</li>
				<li class="nav-item active">
					  <a class="nav-link" href="{{url('upload-documents')}}">डॉक्यूमेंट सत्यापन/अपलोड</a>
				</li>
				@endif
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" key="SCHEME">चयनित अभ्यर्थियों की सूची</a>
						<div class="dropdown-menu" aria-labelledby="dropdown02">
							<a class="dropdown-item" href="{{url('general-list')}}">सामान्य / अन्य  पिछड़ा वर्ग</a> 
							<a class="dropdown-item" href="{{url('sc-list')}}" >अनुसूचित जाति</a> 
							<a class="dropdown-item" href="{{url('st-list')}}" >अनुसूचित जनजाति</a>                
						</div>
				</li>
				
				@if(auth()->user()->user_type=='District Officer')
					<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" key="SCHEME">प्रतीक्षा सूची</a>
						<div class="dropdown-menu" aria-labelledby="dropdown02">
							<a class="dropdown-item" href="{{url('waiting-list')}}/1">सामान्य / अन्य  पिछड़ा वर्ग</a> 
							<a class="dropdown-item" href="{{url('waiting-list')}}/2" >अनुसूचित जाति</a>
							<a class="dropdown-item" href="{{url('waiting-list')}}/3" >अनुसूचित जनजाति</a>                 
						</div>
					</li>
				@endif
				...
				@if(auth()->user()->user_type=='Director')
					<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" key="SCHEME">संस्थान आवंटन</a>
						<div class="dropdown-menu" aria-labelledby="dropdown02">
							<a class="dropdown-item" href="{{url('allocation')}}" >अभ्यर्थी आवंटन </a>
							<a class="dropdown-item" href="{{url('allocation-list')}}" >अभ्यर्थी आवंटन सूची</a>                 
						</div>
				</li>
				@endif
				
				<li class="nav-item active">
					  <a class="nav-link" href="{{url('candidate-not-joined')}}">संस्थान ज्वाइन नहीं किया है</a>
				</li>
          ...
          @else
			<li class="nav-item active" >
              <a class="nav-link" href="{{ url('/') }}" key="HOME" >मुख्य पृष्ठ<span class="sr-only">(current)</span></a>
            </li>
            ...
            <li class="nav-item active">
              <a class="nav-link" href="{{url('lakshya')}}">स्वरोजगारी मैत्री की संख्या</a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="{{url('application-status')}}">आवेदन की स्थिति जानिए</a>
            </li>
            <li class="nav-item active">
  ...
  <div class="row" style="font-size: 16px; line-height: 20px;">
	...
	<div class="col-lg-12">
      <div class="col-md-12 englang">
           <a href="{{ url('/') }}" key="HOME" >मुख्य पृष्ठ <span class="sr-only">(current)</span></a>
