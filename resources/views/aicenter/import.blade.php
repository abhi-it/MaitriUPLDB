...
<div class="container main-div" style="background-color:white; height: 100%; min-height:380px;">
	...
	<h3 class="text-center fw-bold m-4"><span data-hi="AI केंद्र आयात करें" data-en="Import AI Center"></span></h3>
@if (session('error'))
...
@if($errors)
	...
	@endforeach
@endif
	<form method="POST" action="{{ route('importAiCenter') }}" id="loginForm" name="loginForm" enctype="multipart/form-data" style="margin-top:50px">
                        @csrf
                        <div class="row mb-3">
