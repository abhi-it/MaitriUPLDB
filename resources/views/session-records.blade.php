...
<div class="container main-div" style="background-color:white;">
    <h3 class="text-center fw-bold m-4">
        <span data-hi="प्रत्येक सत्र की सभी जिलों की मैत्री का रिकार्ड"
            data-en="Record of maitri of all districts in each session"></span>
    </h3>
    <div class="row">
        <div class="form-group col-md-12">
            <table class="table table-striped  table-responsive table-bordered">
                ...
                @php
                $total =(
                $row->session_2013_14)+($row->session_2014_15)+($row->session_2016_17)+($row->session_2021_2022)+($row->session_2022_23)+($row->session_2023_24);
                @endphp
