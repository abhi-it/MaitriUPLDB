...
<div x-data="" class="container main-div" style="background-color:white; height: 100%;min-height:380px;">
    <h3 class="text-center m-4 fw-bold"> <span data-hi="मासिक मांग अनुरोध सूची"
            data-en="Monthly Demand Request List"></span> </h3>
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control" name="id" id="id">
                            ...
                            <option value="{{$val->name_hindi}}"
                                {{ request()->get('id') == $val->name_hindi ? 'selected' : '' }}>{{$val->name_hindi}}
                            </option>
                            @endforeach
                            @endif
                        </select>
    ...
    <table class="table table-striped  table-responsive table-bordered">
        ...
        <tbody>
            ...
            @php
            $dis_name =
            App\Models\Districts::where(['id'=>$val->district])->select('name_hindi')->pluck('name_hindi')->first();
            @endphp
            ...
            <tr>
                ...
                <td> <a href="javascript:void(0)"
                        class="btn btn-secondary">{{date('d/m/Y', strtotime($val->created_at))}}</a> </td>
                <td>
                    <a href="{{ url('view-request-details') }}/{{ $val->id }}" class="btn btn-secondary">
                        <i class="fa fa-eye" aria-hidden="true"></i>
                    </a>
                    <button class="btn btn-danger deleteRequest" data-id="{{$val->id}}"><i class="fa fa-trash-o"
