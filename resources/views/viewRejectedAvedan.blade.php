    ...
    <form method="get" action="{{Request::url()}}" class="form-comman">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-5 col-xl-3">
                ...
                <input type="text" value="{{@$_GET['applicationNumber']}}" class="form-control" name="applicationNumber"
                    id="applicationNumber" placeholder="आवेदन  नंबर">
            </div>
            ...
            <div class="form-group col-md-5 col-xl-3" style="margin-top: 29px">
                ...
                <a class="btn btn-secondary btn-export"
                    href="{{ route('rejectedAvedan', $queryParameters) }}">Export</a>
                @endif
            </div>
