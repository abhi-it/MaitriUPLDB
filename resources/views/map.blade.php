...
<div class="container mt-5">
    ...
    <center><h2>गोकुल मिशन मानचित्र</h2></center>
...
<script type="text/javascript">
    ...
    async function initMap() {
        ...
        var mapOptions = {
            ...
            //     strictBounds: false,
            // },
            mapId: "1hKRAZmFf8EkAwEJTENjEo566TmTTNDE",
            draggable: true,
...
<table border="1" border-collapse="collapse">
        ...
        for (i = 0; i < convertedAppUpldbCentersData.length; i++) {
            ...
            marker = new google.maps.marker.AdvancedMarkerElement({
                position: new google.maps.LatLng(convertedAppUpldbCentersData[i][1], convertedAppUpldbCentersData[i][2]),
                map: map,
                content: imgIcon,
            });
        ...
        const ctaLayer = new google.maps.KmlLayer({
            url: "https://panel.cognisap.com/kml/map.kml",
            map: map,
        });
