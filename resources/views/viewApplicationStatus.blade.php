    ...
    <div class="container main-div" style="background-color:white; height: 100%;">
        ...
        <h1 style="margin-top:10px;text-align: center;">आवेदन - पत्र
            <div class=" pull-right">
                <a href="{{ url('application-status') }}" class="btn btn-info">Back</a>
            </div>
        </h1>
        ...
        @if (!empty($coments))
            <div class="alert alert-success" style="width: 100%;font-size: 20px;font-weight: bold;">
                {{ $coments->comments }}
            </div>
        @endif
            ...
            <div class="row">
                    ...
                    @if ($result->permanent_address_proof != '')
                        <div class="form-control-span" id="signature1">
                            <img class="img-thumbnail" width="100"
                                src="{{ asset('') }}upload_documents/{{ $result->permanent_address_proof }}">
                        </div>
                        <div class="form-control-span" id="signature1">
                ...
                <div class="form-group col-md-4">
                    ...
                    @if ($result->applicant_photo != '')
                        <div class="form-control-span" id="applicant_photo1">
                            <img class="img-thumbnail" width="100"
                                src="{{ asset('') }}upload_documents/{{ $result->applicant_photo }}">
                        </div>
                        <div class="form-control-span" id="applicant_photo1">
                ...
                <div class="form-group col-md-4">
                    ...
                    @if ($result->signature != '')
                        <div class="form-control-span" id="signature1">
                            <img class="img-thumbnail" width="100"
                                src="{{ asset('') }}upload_documents/{{ $result->signature }}">
                        </div>
                        <div class="form-control-span" id="signature1">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><span class="form-control-span"
                                    id="high_board_name1">{{ $result->high_board_name }}</span></td>
                            <td><span class="form-control-span"
