...
<style>
    ...
    <div x-data="" class="container main-div" style="background-color:white; height: 100%;min-height:380px;">
        <h3 class="text-center m-4 fw-bold">  <span data-hi="विभाजन वस्तुसूची" data-en="Division Inventory"></span> </h3>
        <div class="row mb-4">
            <div class="col-md-12">
                <a href="{{ route('create-disctrict-user-form') }}" data-hi="ब्जिला उपयोगकर्ता आईडी बनाएं" data-en="Create District User ID"  class="btn btn-primary"></a>
            </div>
        </div>
