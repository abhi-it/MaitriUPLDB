...
@section('content')
    ...
    <div x-data="deoUser()" class="container main-div" style="background-color:white; height: 100%;min-height:380px;">
        <h3 class="text-center m-4 fw-bold"> <span data-hi="ब्जिला उपयोगकर्ता आईडी बनाएं" data-en="Create District User ID"></span> </h3>
        <div class="custom-radio-container">
            <div class="row">
                <div class="col-md-12">

                    <h5 class="m-4 fw-bold"> <span data-hi="आपका विभाग" data-en="Your Division"></span> </h5>
                            ...
                            <div class="col-md-4">
                                <div class="custom-radio">
                                    <label class="radio-button-container">
                                        <span :for="'division' + division.id" :data-hi="division.name_hindi" :data-en="division.name_eng"
                                            x-text="localStorage.getItem('selectedProject') === 'en' ? division.name_eng : division.name_hindi"></span>
                                        <input type="radio" class="division" name="division" :id="'division' + division.id"
        ...
        function deoUser() {
            return {
                ...
                createDEOUser() {
                    ...
                    axios.post('{{ route('district-store-data') }}', {
                            zone: zone_id,
                        ...
                        .then(response => {
                            ...
                            window.location.href = '{{ route('division-store-data-step2') }}';
