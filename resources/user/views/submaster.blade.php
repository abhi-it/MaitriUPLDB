                                ...
                                @if (Route::has('login'))
                                    @auth
                                        @if(Auth::user()->role_id=='3')
                                            ...
                                            <li class="nav-item active">
                                                <a class="nav-link" href="{{ url('/monthly-report') }}">मासिक प्रगति रिपोर्ट (एमपीआर) </a>
                                            </li>
                                        @else
                                            <li class="nav-item active">
...
<footer class="position-relative">
        ...
        <div class="row g-3 footer_top_footer__u_0LC">
            ...
            <div class="col-lg-4">
                <div class="d-flex flex-column justiry-content-center align-items-center w-100">
                    <h5>Download App</h5><a href="#"><img src="https://upldb.vercel.app/assets/images/site/pashudhan_app1.png" width="120px" alt=""></a>
                </div>
            </div>
        </div>
    <div class="row align-items-top gap-5 px-2 mx-0 pt-4 pb-3 footer_footer__O">
        <div class="col-lg-3 align-items-top text-center">
            ...
            <span style="line-height:25px;display:block" class="mb-0 mt-3 text-white"> उन्नत संतति हेतु संकल्पबद्ध</span>
