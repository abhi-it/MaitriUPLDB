    ...
    <div class="container main-div" style="background-color:white; height: 100%;">
        ...
        <div class="tab1">
            ...
            <div class="row">
                ...
                <h3 class="my-3 fw-bold">शैक्षिक योग्यता व अन्य विवरण </h3>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <span class="form-control-span" id="health_certificate1">
                            @if ($result->health_certificate != '')
                                <img class="img-thumbnail" width="100"
                                    src="{{ asset('') }}upload_documents/{{ $result->health_certificate }}">
                                <a href="{{ asset('') }}upload_documents/{{ $result->health_certificate }}"
                                    target="_blank">View</a>
                            @else
                                No documents
                            @endif
                    ...
                    <div class="row mb-5 mt-4"> 
                        ...
                        @if(auth()->user()->user_type != 'District Officer')
                            ...
                            <a href="javascript:void(0)" class="btn btn-danger  text-white w-100"
                                data-toggle="modal" data-target="#exampleModalCenter">अस्वीकार </a></div>
                            @endif
                        @endif
                    </div>
                @else
                    <div class="row mb-5 mt-4 result-btn">
                        @if($result->is_approved == 0 || $result->is_approved == 1 || $result->is_approved == 2)
                        <a href="{{ url('avedanStatus') }}/{{ $result->id }}/3" class="btn btn-warning col-md-6 ml-5">प्रतीक्षा सूची
                            बनायें </a>
                        @endif
                        @if(auth()->user()->user_type != 'District Officer')
                            @if ($result->is_approved == 0 || $result->is_approved ==3)
                            <a href="javascript:void(0)" class="btn btn-danger col-md-6 ml-5 text-white" 
