    ...
    <header>
        ...
        <div class="container py-3">
            <div class="row g-3 align-items-center">
                <div class="col-lg-8 col-md-12 col-12">
                   <div class="d-flex flex-wrap align-items-center gap-2 justify-content-md-start justify-content-center">
                    <div class="d-flex align-items-center gap-2">
                        <div class="text-center">
                            <a  href="{{ url('/') }}"> <img src="{{ asset('assets/images/logo.png') }}" height="100" /></a>
                           </div>
                           <span class="middle-line">|</span>
                           <div class="text-center">
                            <a href="{{ url('/') }}"> 
                    ...
                    <div class="text-md-left text-center">
                        ...
                        <span data-hi="राष्ट्रीय गोकुल मिशन" data-en="Rashtriya Gokul Mission"></span>   </h1>
                        <h6>
                        <span data-hi="स्वरोजगारी मैत्री (मल्टीपरपज ए0आई0 टेक्निशियन इन रूरल इण्डिया) हेतु ऑनलाइन आवेदन" data-en="Online Application for Swarojgari Maitri (Multipurpose AI Technician in Rural India)"></span>
                        </h6>
                    </div>
                   </div>
                </div>
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="d-flex flex-column ">
                        ...
                        <span>Email ID - <a href="mailto:upldb@rediffmail.com">upldb@rediffmail.com</a></span>
                     </div>
      ...
      <nav class="navbar navbar-expand-xl m-0 p-0">
        <div class="container-fluid justify-content-end">
          <button  class="navbar-toggler my-1 bg-white py-1 px-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDarkNavbar"  aria-controls="offcanvasDarkNavbar" aria-label="Toggle navigation" >
                            ...
                            @if (auth()->user()->user_type == 'District Officer')
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ url('upload-documents') }}">
                                        <span data-hi="अभिलेख  सत्यापन" data-en="Document Verification/Upload"></span> 
                                    </a>
                                </li>
                            @endif
                                <li class="nav-item dropdown">
