            ...
            <div class="col-lg-6">
                <div class="card p-2 mb-3">
                    <h5 class="site--heading">
                        <span data-hi="राष्ट्रीय गोकुल मिशन अन्तर्गत मैत्री के बारे में"
                            data-en="About Maitri under National Gokul Mission"></span>
                    </h5>
                    <p>
            ...
            <div class="col-lg-6">
                <div class="user-list-section">
                    ...
                    <div class="row g-3 justify-content-center">
                            ...
                            <div class="user-detail">
                                ...
                                <div>
                                    ...
                                    <p class="m-0 text-center lh-1"><small>
                                            <span data-hi="माननीय मुख्यमंत्री, उत्तर प्रदेश।"
                                                data-en="Hon'ble Chief Minister, U.P."></span>
                                        </small></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="user-detail">
                                ...
                                <div>
                                    ...
                                    <p class="m-0 text-center lh-1"><small>
                                            <span data-hi="माननीय मंत्री डेयरी विकास विभाग, पशुपालन, उत्तर प्रदेश।"
                                                data-en="Hon`ble Minister Dairy Development Dept., Animal Husbandry,U.P."></span>
                                        </small></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="user-detail">
                                <img src="{{ asset('assets/images/jaikesh-ceo.png')}}" />
                                <div>
                                    <p class="m-0 text-center"><b>
                                            <span data-hi="डॉ. जयकेश कुमार पांडेय"
                                                data-en="Dr. Jaikesh Kumar Pandey"></span>
                                        </b></p>
                                    <p class="m-0 text-center lh-1"><small>
                ...
                <div class="row align-items-center g-3">
                    <div class="col-xl-9 col-lg-6">
                        <h3 class="fw-bold mb-3 logo-title">
                            <span data-hi="माननीय पशुपालन मंत्री, उत्तर प्रदेश का संदेश"
                                data-en="Message from Hon`ble Minister, Animal Husbandry, U.P."></span>
                        </h3>
                        <p><i>
                                <span
                                    ...
                                    data-en="“The board's objective shall be to encourage, promote, and carry out viable, activities to improve the
        ...
        <div class="row user-list-section align-items-center justify-content-center g-3 mb-5">
            <div class="col-xl-10">
                <div class="row align-items-center g-3">
                    <div class="col-xl-9 col-lg-6">
                        <h3 class="fw-bold mb-3 logo-title">
                            <span data-hi="यूपीएलडीबी के सीईओ का संदेश"
                                data-en="Message from C.E.O, UPLDB, U.P."></span>
                        </h3>
                        <p><i>
                                <span
                                    data-hi="हमारा उद्देश्य नियमित और निरंतर आधार पर सभी स्तरों पर कौशल और व्यावसायिक क्षमता को बढ़ाने के लिए मौजूदा सुविधाओं का आधुनिकीकरण और उन्नयन करना है। पशुधन के प्रजनन और विकास तथा उनकी उत्पादकता से संबंधित संस्थागत ढांचे को समग्र रूप से मजबूत बनाने में राज्य सरकार को सलाह और सहायता देना, तथा राज्य भर में पशुधन प्रजनन बुनियादी ढांचे पर पहले से किए गए निवेश पर अधिकतम लाभ प्राप्त करने के लिए नई संस्थाओं की स्थापना में सहायता करना। उत्पादकता वृद्धि और उद्यम संवर्धन के लिए तकनीकी सहायता प्रदान करना। देशी नस्लों के संरक्षण और आनुवंशिक उन्नयन के लिए पहल को बढ़ावा देना। जैव विविधता और आनुवंशिक संसाधनों के संरक्षण और आर्थिक महत्व के पशुधन की देशी नस्लों के विकास और वाणिज्यिक दोहन में राष्ट्रीय प्रयास में सहायता करना। प्रजनन क्षेत्र में बोर्ड के लिए विकास गतिविधियों को बढ़ावा देना और वित्तपोषित करना।"
                ...
                development activities for the board in the breeding sector."></span>
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="author-section">
                            <img class="w-100" src="{{ asset('assets/images/jaikesh-ceo.png')}}" />
                            <span data-hi="डॉ. जयकेश कुमार पांडेय" data-en="Dr. Jaikesh Kumar Pandey"></span>
                            <span></span>
                        </div>
                    </div>
                </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-6 p-2">
                <div class="text-center">
                    ...
                    <p class="text-center text-white fs-4 counter">1359000</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-6 p-2">
                <div class="text-center">
        ...
        <div class="row">
            <div class="col-md-12">
                <h4 class="text-center fw-bold">
                    <span data-hi="पशुधन में क्रांतिकारी बदलाव: अत्याधुनिक खेती के माध्यम से जीवन को जोड़ना!"
                        data-en="Revolutionizing Livestock: Connecting Lives through Cutting-Edge Farming!"></span>
                </h4>
            </div>
        </div>
        <div class="row g-3 my-3">
            <div class="col-lg-2 col-md-6 col-6 px-2">
                <div class="flip-card">
                    <div class="flip-face flip-face-front">
                        ...
                        <h5>
                            <span data-hi="राष्ट्रीय गोजातीय प्रजनन परियोजना"
                                data-en="NATIONAL PROJECT FOR BOVINE BREEDING"></span>
                        </h5>
                    </div>
                    <div class="flip-face flip-face-back">
                        <p>
                            <span
                                data-hi="राज्य के सभी प्रजनन योग्य मवेशियों को कृत्रिम गर्भाधान कार्यक्रम के माध्यम से कवर करने के इरादे से, जमे हुए सीमेन का उपयोग करते हुए, भारत सरकार राष्ट्रीय गोजातीय प्रजनन परियोजना को प्रायोजित कर रही है।"
                                data-en="Intending to cover the entire breedable cattle of the state through the AI program, using frozen semen,
            ...
            <div class="col-lg-2 col-md-6 col-6 px-2">
                <div class="flip-card">
                    ...
                    <div class="flip-face flip-face-back">
                        <p><span data-hi="उत्तर प्रदेश में बकरियों की आबादी का बड़ा हिस्सा जमुनापारी नस्ल का है और यह राज्य की कृषि-जलवायु परिस्थितियों के अनुकूल है। विविधीकरण कार्यक्रम के एक भाग के रूप में, बोर्ड..."
                                data-en="The major proportion of the goat population in Uttar Pradesh belongs to the Jamunapari breed and is well
              adapted to the agro-climatic conditions of the State. As a part of the diversification program, the
              Board..."></span>
                        </p>
                        <button class="btn btn-primary w-100"> <span data-hi="और जानें" data-en="Know More"></span>
                        </button>
                    </div>
                </div>
            </div>
            <div class="col-lg-2 col-md-6 col-6 px-2">
                <div class="flip-card">
                    ...
                    <div class="flip-face flip-face-back">
                        <p><span data-hi="आर्थिक रूप से किफायती डेयरी फार्मिंग में उचित आहार के महत्व पर अधिक जोर देने की आवश्यकता नहीं है। बोर्ड ने शुरू से ही चारा विकास को सबसे महत्वपूर्ण गतिविधियों में से एक के रूप में लिया था।"
                                data-en="The importance of proper feeding in economic dairy farming need not be overemphasized. The Board had
              taken up fodder development as one of the most important activities right from the very beginning."></span>
                        </p>
                        <button class="btn btn-primary w-100"><span data-hi="और जानें"
                                data-en="Know More"></span></button>
                    </div>
                </div>
            </div>
            <div class="col-lg-2 col-md-6 col-6 px-2">
                <div class="flip-card">
                    ...
                    <div class="flip-face flip-face-back">
                        <p><span data-hi="राज्य ने गाय प्रजनन के लिए इनपुट प्रदान करने के लिए तीन स्तरीय कृत्रिम गर्भाधान (ए.आई.) प्रबंधन प्रणाली विकसित की है, जिसमें बैल स्टेशन, क्षेत्रीय सीमेन बैंक (आरएसबी) और कृत्रिम गर्भाधान केंद्र शामिल हैं।"
                                data-en="The State has evolved a three-tier Artificial Insemination (A.I.) management system to provide the inputs for cattle breeding namely Bull Stations, Regional Semen Banks (RSB), and Artificial Insemination Centres.">
                        </p>
                        <button class="btn btn-primary w-100"><span data-hi="और जानें"
                                data-en="Know More"></span></button>
                    </div>
            ...
            <div class="col-lg-2 col-md-6 col-6 px-2">
                <div class="flip-card">
                    ...
                    <div class="flip-face flip-face-back">
                        <p>
                            <span
                                data-hi="अगली पीढ़ी के लिए सबसे उपयुक्त सांडों की पहचान करने के लिए, यूपीएलडीबी ने क्षेत्र संतान-परीक्षण कार्यक्रम शुरू किया, जिसमें दो बुनियादी कार्य शामिल थे।"
                                data-en=" To identify the most suitable bulls as the sires for the next generation, the UPLDB ventured into the
            ...
            <div class="col-lg-2 col-md-6 col-6 px-2">
                <div class="flip-card">
                    ...
                    <div class="flip-face flip-face-back">
                        <p>
                            <span
                                data-hi="बेहतर नस्ल के सांडों के उत्पादन के लिए मल्टीपल ओवुलेशन एम्ब्रियो ट्रांसफर (एमओईटी) की शुरुआत की गई। इस तकनीक के तहत, बेहतरीन गायों की आनुवंशिक गुणवत्ता का उपयोग अगली पीढ़ी के सांडों के उत्पादन के लिए किया जाता है।"
                                data-en=" Multiple Ovulation Embryo Transfer (MOET) was introduced for the production of superior sires. Under this
...
<section class="py-5 my-3 counter-section">
    <div class="container">
        <div class="d-flex mb-5 flex-column align-items-center justify-content-center text-white text-center">
            <small><span data-hi="आंकड़े" data-en="STATISTICS"></span> 2020-2024</small>
...
<section class="py-4">
    <div class="container">
        <div class="row">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                <img src="https://upldb.vercel.app/assets/images/zone/vanansi-zone.jpeg" width="100%"
                                    alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                <img src="https://upldb.vercel.app/assets/images/zone/jhansi-zone.jpeg" width="100%"
                                    alt="">
                                <div class="position-absolute">
                                    <p> <span data-hi="गोरखपुर जोन" data-en="Gorakhpur Zone"></span> </p>
                                    <a href="#"> <span data-hi="और जानें" data-en="Know More"></span> </a>
                        ...
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                <img src="https://upldb.vercel.app/assets/images/zone/gorakhpur%20-zone.jpeg"
                                    width="100%" alt="">
                                <div class="position-absolute">
                                    <p> <span data-hi="गोरखपुर जोन" data-en="Gorakhpur Zone"></span> </p>
                                    <a href="#"> <span data-hi="और जानें" data-en="Know More"></span> </a>
                        ...
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                <img src="https://upldb.vercel.app/assets/images/zone/kanpur-zone.jpeg" width="100%"
                                    alt="">
                                <div class="position-absolute">
                                    <p> <span data-hi="गोरखपुर जोन" data-en="Gorakhpur Zone"></span> </p>
                                    <a href="#"> <span data-hi="और जानें" data-en="Know More"></span> </a>
                        ...
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                <img src="https://upldb.vercel.app/assets/images/zone/agra-zone.jpeg" width="100%"
                                    alt="">
                                <div class="position-absolute">
                                    <p> <span data-hi="गोरखपुर जोन" data-en="Gorakhpur Zone"></span> </p>
                                    <a href="#"> <span data-hi="और जानें" data-en="Know More"></span> </a>
            ...
            <div class="col-lg-6">
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                <img src="https://upldb.vercel.app/assets/images/shemen-prod/lucknow-station.jpeg"
                                    width="100%" alt="">
                                <div class="position-absolute">
                                    <p> <span data-hi="गोरखपुर जोन" data-en="Gorakhpur Zone"></span> </p>
                                    <a href="#"> <span data-hi="और जानें" data-en="Know More"></span> </a>
                        ...
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                <img src="https://upldb.vercel.app/assets/images/shemen-prod/babugharh-station.jpeg"
                                    width="100%" alt="">
                                <div class="position-absolute">
                                    <p> <span data-hi="गोरखपुर जोन" data-en="Gorakhpur Zone"></span> </p>
                                    <a href="#"> <span data-hi="और जानें" data-en="Know More"></span> </a>
            ...
            <div class="col-lg-6">
                <h3 class="text-center mb-2  mt-4"><span data-hi="बुल मदर फार्म्स (बीएमएफ)"
                        data-en="Bull Mother Farms(BMF)"></span>
                </h3>
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                <img src="https://upldb.vercel.app/assets/images/bmf/arazilines-varanasi-bmf.jpeg"
                                    width="100%" alt="">
                                <div class="position-absolute">
                                    <p> <span data-hi="गोरखपुर जोन" data-en="Gorakhpur Zone"></span> </p>
                                    <a href="#"> <span data-hi="और जानें" data-en="Know More"></span> </a>
            ...
            <div class="col-lg-6">
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                <img src="https://upldb.vercel.app/assets/images/artfi-traning-center/baif-pratapgharh.jpeg"
                                    width="100%" alt="">
                                <div class="position-absolute">
                                    <p> <span data-hi="गोरखपुर जोन" data-en="Gorakhpur Zone"></span> </p>
                                    <a href="#"> <span data-hi="और जानें" data-en="Know More"></span> </a>
                        ...
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                <img src="https://upldb.vercel.app/assets/images/artfi-traning-center/gourakhpur.jpeg"
                                    width="100%" alt="">
                                <div class="position-absolute">
                                    <p> <span data-hi="गोरखपुर जोन" data-en="Gorakhpur Zone"></span> </p>
                                    <a href="#"> <span data-hi="और जानें" data-en="Know More"></span> </a>
                        ...
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                <img src="https://upldb.vercel.app/assets/images/artfi-traning-center/meerut.jpeg"
                                    width="100%" alt="">
                                <div class="position-absolute">
                                    <p> <span data-hi="गोरखपुर जोन" data-en="Gorakhpur Zone"></span> </p>
                                    <a href="#"> <span data-hi="और जानें" data-en="Know More"></span> </a>
                        ...
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                <img src="https://upldb.vercel.app/assets/images/artfi-traning-center/agra.jpeg"
                                    width="100%" alt="">
                                <div class="position-absolute">
                                    <p> <span data-hi="गोरखपुर जोन" data-en="Gorakhpur Zone"></span> </p>
                                    <a href="#"> <span data-hi="और जानें" data-en="Know More"></span> </a>
                        ...
                        <div class="swiper-slide">
                            <div class="page_sliderDiv">
                                <img src="https://upldb.vercel.app/assets/images/artfi-traning-center/barelly.jpeg"
                                    width="100%" alt="">
                                <div class="position-absolute">
                                    <p> <span data-hi="गोरखपुर जोन" data-en="Gorakhpur Zone"></span> </p>
                                    <a href="#"> <span data-hi="और जानें" data-en="Know More"></span> </a>
        ...
        <div class="row">
            <div class="logo-swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="logo-box">
                            <a href="http://pmindia.gov.in/" target="_blank"><img
                                    src="{{ asset('images/footer-logos/logo1.png')}}" /></a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="logo-box">
                            <a href="https://data.gov.in/" target="_blank"><img
                                    src="{{ asset('images/footer-logos/dpi.jpg')}}" /></a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="logo-box">
...
$(function() {
    $('.counter').each(function() {
        $(this).prop('Counter', 0).animate({
            ...
            easing: 'swing',
            step: function(now) {
                $(this).text(Math.ceil(now).toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g,
                    "$1,"));
            }
        });
    });
