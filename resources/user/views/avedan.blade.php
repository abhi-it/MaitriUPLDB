        ...
        <form method="post" action="{{ route('application-form.store') }}" id="myForm" enctype="multipart/form-data">
            ...
            <div class="tab">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputEmail4"><span data-hi="ग्राम पंचायत का नाम" data-en="Name of Gram Panchayat"> </span> </label> <span class="text-danger">*</span>
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputEmail4"><span data-hi="पत्र - व्यवहार का पता" data-en="Postal address"> </span>
                        </label> <span class="text-danger">*</span>
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputPassword4"><span data-hi="एआई सेंटर (पशु चिकित्सा अस्पताल / एलईओ सेंटर)" data-en="AI Centre (Veterinary Hospital / LEO Center)"> </span>  </label> <span class="text-danger">*</span>
