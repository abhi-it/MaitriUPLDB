...
<div class="container main-div" style="background-color:white; height: 100%; min-height:380px;">
 ...
 <h1 style="margin-top:10px;text-align: center;">Import Maitri</h1>
@if (session('error'))
...
@if($errors)
	...
	@endforeach
@endif
	<form method="POST" action="{{ route('importMaitries') }}" id="loginForm" name="loginForm" enctype="multipart/form-data" style="margin-top:50px">
                        @csrf
                        <div class="row mb-3">
