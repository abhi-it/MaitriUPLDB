...
/*--------------------Start Calculation for certification (Getting montd and Days)-------------*/
	   $training_certificate_period_in_montd = $results->training_certificate_period_in_montd;
	   $training_certificate_period_in_days = $results->training_certificate_period_in_days;

	   $training_certificate_period_in_montd = ($training_certificate_period_in_montd)?$training_certificate_period_in_montd:0;
	   $training_certificate_period_in_days = ($training_certificate_period_in_days)?$training_certificate_period_in_days:0;

	   $total_number_of_training_days = ($training_certificate_period_in_montd*30) + $training_certificate_period_in_days;

	   if($total_number_of_training_days>=1 && $total_number_of_training_days<=30){ //upto 1 montd

		   $gettingAnk = 4;

	   } else if($total_number_of_training_days>30 && $total_number_of_training_days<=60){ // 1-2 montds

		   $gettingAnk = 8;

	   } else if($total_number_of_training_days>60 && $total_number_of_training_days<=90){ // 2-3 montds

		   $gettingAnk = 12;

	   } else if($total_number_of_training_days>90 && $total_number_of_training_days<=120){ // 3-4 montds

		   $gettingAnk = 16;

	   } else if($total_number_of_training_days>120){ // more tdan 4 montds
	   ...
	   /*--------------------End Calculation for certification (Getting montd and Days)-------------*/
...
<table class="table table-bordered">
    <tdead>
        ...
        {{-- <tr>
            <td>प्रशिक्षण का प्रमाण पत्र</td>
            <td>प्रशिक्षण की अवधि माह ({{$results->training_certificate_period_in_montd}})</td>
            <td>दिन ({{$results->training_certificate_period_in_days}})</td>
            <td colspan="3" style="text-align:right;">स्वतः मूल्यांकन अंक<br>
            <?php //echo $gettingAnk;?>
            </td>
        </tr> --}}

        <tr>
            <td colspan="5" style="text-align:right;">कुल स्वतः मूल्यांकन अंक</td>
