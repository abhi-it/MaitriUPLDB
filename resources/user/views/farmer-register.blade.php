        ...
        <form method="post" action="{{ route('farmer-add') }}" class="form-comman">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="optionBox">
                        <div class="block row adddiv_0">
                            ...
                            <div class="form-group col-md-5">
                                <input type="number" class="form-control" id="cattale_no" name="cattale_no[]" required placeholder="मवेशियों की संख्या" autocomplete="off" >
                            </div> 
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="breeds" name="breeds" required placeholder="गाय/भैंस की नस्लें" autocomplete="off" >
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="gram_panchayat" name="gram_panchayat" required placeholder="ग्राम पंचायत" autocomplete="off" >
                </div>
                <div class="form-group col-md-6">
                    <label for="inputPassword4">
