...
class DashboardController extends Controller
{
	...
	public function index(Request $request, $year = null)
	{
		...
		return view($template, compact('results', 'newApplication', 'approvedApplication', 'rejectedApplication', 'generalList', 'SClist', 'STlist', 'waitingList', 'maitriDistricts', 'upldbCenters', 'avedanYears', 'sessionYear'));
	}
